      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative">
        <div className="w-full md:w-1/2 space-y-8 z-10">
          <div className="space-y-4">
            <h3 className="text-blue-600 font-bold tracking-widest uppercase text-sm">Tentang Program Studi</h3>
            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight text-gray-900">
              Produksi Media Vokasi <br /> Universitas Indonesia
            </h2>
          </div>
          <p className="text-gray-600 text-lg leading-relaxed text-justify">
            Produksi Media adalah sebuah program studi di Vokasi Universitas Indonesia dengan jenjang Diploma 4 (D4) yang mempersiapkan mahasiswa untuk menguasai bidang dan terjun ke industri Media Digital.
          </p>
          <Link 
            to="/contact" 
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="space-y-4">
                <h3 className="text-blue-600 font-bold tracking-widest uppercase text-sm">Portfolio</h3>
                <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900">Karya Mahasiswa</h2>
                <p className="text-gray-500 max-w-lg">Eksplorasi karya inovatif, kreatif, dan inspiratif dari mahasiswa Produksi Media yang berkolaborasi dari berbagai studio peminatan.</p>
            </div>
            <Link to="/karya" className="hidden md:flex items-center gap-2 text-blue-700 font-bold hover:gap-4 transition-all uppercase tracking-wider text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="group rounded-2xl overflow-hidden shadow-xl bg-white hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 text-center z-10 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                   <h3 className="text-3xl font-bold mb-2">Stars in Your Eyes</h3>
              ...
              <div className="p-8 relative bg-white">
                ...
                <p className="text-xs text-blue-600 font-black mb-1 uppercase tracking-wider">Musics / Wire</p>
                <p className="text-gray-800 font-bold text-lg mb-6">Oleh: Noufal Adika</p>
            ...
            <div className="group rounded-2xl overflow-hidden shadow-xl bg-white hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 text-center z-10 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                   <h3 className="text-3xl font-bold mb-2">Animal Resource Dept</h3>
                   <div className="w-12 h-1 bg-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"></div>
                </div>
              </div>
              <div className="p-8 relative bg-white">
                ...
                <p className="text-xs text-purple-600 font-black mb-1 uppercase tracking-wider">Game / OxLab</p>
                <p className="text-gray-800 font-bold text-lg mb-6">Oleh: Dicari Programmer</p>
            ...
            <div className="group rounded-2xl overflow-hidden shadow-xl bg-white hover:shadow-2xl transition-all duration-500 border border-gray-100">
              ...
              <div className="p-8 relative bg-white">
                ...
                <p className="text-xs text-orange-600 font-black mb-1 uppercase tracking-wider">Comics / Pojokomik</p>
                <p className="text-gray-800 font-bold text-lg mb-6">Oleh: Haura Shalihah</p>
          ...
          <Link to="/karya" className="mt-12 flex justify-center items-center gap-2 text-blue-700 font-bold uppercase tracking-wider text-sm md:hidden">
              Lihat Semua Karya <span>&rarr;</span>
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16 space-y-4">
             <h3 className="text-blue-600 font-bold tracking-widest uppercase text-sm">Pembaruan & Artikel</h3>
             <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900">Berita Terbaru</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Vokasi UI mengembangkan studio mini human computer interaction", cat: "HCI / SPICE", tags: "POLAR LAB", color: "from-blue-500 to-blue-700" },
              { title: "Promed Streams, tentukan peranmu di POLAR LAB", cat: "PROMATES", tags: "POLAR LAB", color: "from-emerald-500 to-teal-700" },
              { title: "Aplikasi Game Pertama Promed & Vokasi UI", cat: "GAME / OX-Lab", tags: "POLAR LAB", color: "from-rose-500 to-red-700" },
            ].map((news, idx) => (
              <div key={idx} className="group bg-white rounded-2xl shadow-sm hover:shadow-xl p-6 transition-all duration-300 border border-gray-100 flex flex-col h-full">
                <div className={`h-40 rounded-xl mb-6 bg-gradient-to-br ${news.color} opacity-90 group-hover:opacity-100 transition-opacity flex items-end p-4`}>
                ...
                <p className="text-xs font-black text-gray-400 mb-3 uppercase tracking-widest">{news.cat}</p>
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                    <p className="text-sm text-gray-500 font-medium">Oleh: Reiky Perkasa</p>
                    <a href="#" className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        &rarr;
                    </a>
                </div>
              </div>
